...
public class ExpressionTests
{
    ...
    /// <summary>
    /// Verifies that the parser accepts slice expression.
    /// </summary>
    ...
    /// <summary>
    /// Verifies that the parser accepts slice expression with back index.
    /// </summary>
    ...
    /// <summary>
    /// Verifies that the parser accepts slice expression into the expected AST shape.
    /// </summary>
    ...
    /// <summary>
    /// Verifies that the parser accepts slice expression til range.
    /// </summary>
    ...
    /// <summary>
    /// Verifies that the parser accepts slice expression and rejects unsupported step syntax.
    /// </summary>
