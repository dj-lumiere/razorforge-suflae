...
///
/// <para>SA leaves a call <c>Unknown</c> when overload resolution fails during Phase 5 -> typically because the receiver type lacked its module prefix at analysis time (types
