...
/// <c>RoutineReachabilityPass</c>. Codegen Phase A uses this to gate stdlib
...
/// cancellation push/pop (9-2). Empty for any program that never reaches a suspend primitive.</param>
