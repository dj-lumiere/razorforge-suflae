...
/// <see cref="SemanticVerification.Symbols.RoutineInfo.ThrowableTypes"/> is populated,
/// and before <see cref="PatternLoweringPass"/> so the expanded
/// <see cref="TypePattern"/> clauses can be lowered.
/// </summary>
internal sealed class CrashableExpansionPass(DesugaringContext ctx)
{
    ...
    private static bool IsResultOrLookup(SemanticVerification.Types.TypeInfo? type)
    {
    ...
    private static string GetCarrierBaseName(SemanticVerification.Types.TypeInfo type)
    {
