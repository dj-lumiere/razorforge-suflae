...
/// </summary>
internal sealed class OperatorLoweringPass(DesugaringContext ctx)
{
    ...
    private Expression LowerExpression(Expression expr)
    {
        switch (expr)
        {
            ...
            case BinaryExpression bin:
            {
                ...
                SemanticVerification.Symbols.RoutineInfo? resolvedMethod = null;
                ...
                if (receiverType is SemanticVerification.Types.FlagsTypeInfo
                ...
                if (receiverType is SemanticVerification.Types.ChoiceTypeInfo
            ...
            case UnaryExpression { Operator: UnaryOperator.ForceUnwrap } forceUnwrap:
            {
                ...
                SemanticVerification.Symbols.RoutineInfo? unwrapMethod = operandType != null
            ...
            case UnaryExpression unary:
            {
                ...
                if (operandType is SemanticVerification.Types.FlagsTypeInfo
                    && methodName == "$bitnot")
                {
                    return ReferenceEquals(operand, unary.Operand)
                        ? expr
                ...
                SemanticVerification.Symbols.RoutineInfo? resolvedUnaryMethod = null;
                if (operandType != null)
                {
    ...
    /// <summary>
    /// Lowers operator expressions in all synthesized bodies stored in <see cref="DesugaringContext.VariantBodies"/>.
