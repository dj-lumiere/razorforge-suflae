...
public sealed class IntrinsicTypeInfo : TypeInfo
{
    ...
    public static class WellKnown
    {
        ...
        /// </summary>
        public static readonly IntrinsicTypeInfo I1 = new(name: "@intrinsic.i1", llvmType: "i1", bitSize: 1);
        ...
        /// </summary>
        public static readonly IntrinsicTypeInfo I8 = new(name: "@intrinsic.i8", llvmType: "i8", bitSize: 8);
        ...
        /// </summary>
        public static readonly IntrinsicTypeInfo I16 = new(name: "@intrinsic.i16", llvmType: "i16", bitSize: 16);
        ...
        /// </summary>
        public static readonly IntrinsicTypeInfo I32 = new(name: "@intrinsic.i32", llvmType: "i32", bitSize: 32);
        ...
        /// </summary>
        public static readonly IntrinsicTypeInfo I64 = new(name: "@intrinsic.i64", llvmType: "i64", bitSize: 64);
        ...
        /// </summary>
        public static readonly IntrinsicTypeInfo I128 = new(name: "@intrinsic.i128", llvmType: "i128", bitSize: 128);

        // Pointer-sized integers
        /// <summary>
        /// Represents a pointer-sized integer type (e.g., "iptr").
        /// </summary>
        public static readonly IntrinsicTypeInfo Iptr = new(name: "@intrinsic.iptr", llvmType: "iptr", bitSize: 0, isPointerSized: true);

        /// <summary>
        /// Represents an unsigned pointer-sized integer type (e.g., "uptr").
        /// </summary>
        public static readonly IntrinsicTypeInfo Uptr = new(name: "@intrinsic.uptr", llvmType: "uptr", bitSize: 0, isPointerSized: true);

        // Floating point
        /// <summary>
        /// Represents a 16-bit floating-point type (e.g., "half").
        /// </summary>
        public static readonly IntrinsicTypeInfo F16 = new(name: "@intrinsic.f16", llvmType: "half", bitSize: 16, isFloatingPoint: true);

        /// <summary>
        /// Represents a 32-bit floating-point type (e.g., "float").
        /// </summary>
        public static readonly IntrinsicTypeInfo F32 = new(name: "@intrinsic.f32", llvmType: "float", bitSize: 32, isFloatingPoint: true);

        /// <summary>
        /// Represents a 64-bit floating-point type (e.g., "double").
        /// </summary>
        public static readonly IntrinsicTypeInfo F64 = new(name: "@intrinsic.f64", llvmType: "double", bitSize: 64, isFloatingPoint: true);

        /// <summary>
        /// Represents a 128-bit floating-point type (e.g., "fp128").
        /// </summary>
        public static readonly IntrinsicTypeInfo F128 = new(name: "@intrinsic.f128", llvmType: "fp128", bitSize: 128, isFloatingPoint: true);

        // Raw pointer
        /// <summary>
        /// Represents a raw pointer type (e.g., "ptr").
        /// </summary>
        public static readonly IntrinsicTypeInfo Ptr = new(name: "@intrinsic.ptr", llvmType: "ptr", bitSize: 0, isPointerSized: true);
