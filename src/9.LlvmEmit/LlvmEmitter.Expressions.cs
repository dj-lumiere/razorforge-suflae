...
public partial class LlvmEmitter
{
    ...
    {
        // v0.2.0 9-2: cancellation markers inserted by CancellationInstrumentationPass. Recognised
        ...
        if (call.Callee is IdentifierExpression
            {
                Name: Lowering.Passes.CancellationInstrumentationPass.PushMarker
            })
        {
        ...
        if (call.Callee is IdentifierExpression
            {
                Name: Lowering.Passes.CancellationInstrumentationPass.PopMarker
            })
        {
